...
export interface Tutorial {
    ...
    promptTemplate?: string;    // 복사해서 쓸 수 있는 프롬프트 템플릿
}
...
export const TUTORIALS: Tutorial[] = [
    ...
    },
    {
        id: "personal-color",
        emoji: "🎨",
        title: "퍼스널컬러 체험 → 브랜드 컬러 기획",
        desc: "AI 퍼스널컬러 진단을 직접 체험하고 브랜드 컬러 전략으로 연결하는 5회차 인트로 활동",
        color: "#FF6B35",
        bg: "#FFF0EB",
        difficulty: "초급",
        duration: "15분",
        ...
        steps: [
            {
                title: "퍼스널컬러 진단 체험",
                desc: "아래 링크에 접속하여 AI 퍼스널컬러 진단을 직접 체험해보세요.\n\n🔗 [Gemini 퍼스널컬러 진단 체험하기](https://gemini.google.com/share/48d562643e55)\n\n진단 결과(봄/여름/가을/겨울 타입)와 추천 컬러 팔레트를 확인하고 스크린샷을 찍어두세요!",
                tip: "팀원 각자 진단 후 결과를 공유하면 다양한 컬러 타입을 비교할 수 있어요.",
            },
            {
                title: "결과 정리 — 나의 컬러 타입은?",
                desc: "진단 결과를 바탕으로 내 컬러 유형과 추천 컬러 3가지를 적어봐요.\n\n**봄 웜톤:** 피치, 코랄, 아이보리\n**여름 쿨톤:** 라벤더, 베이비핑크, 스카이블루\n**가을 웜톤:** 테라코타, 카멜, 올리브\n**겨울 쿨톤:** 버건디, 네이비, 블랙",
            },
            {
                title: "브랜드 컬러로 확장하기",
                desc: "내 퍼스널컬러 경험을 팀 브랜드에 적용해봐요. Gemini에게 아래 프롬프트를 입력해 보세요!\n\n💬 '우리 상품 [상품명]에 어울리는 브랜드 메인 컬러 2가지를 추천해줘. 각 컬러의 심리적 의미와 타겟 고객에게 왜 매력적으로 느껴지는지 설명해줘.'",
                tip: "퍼스널컬러 체험에서 느낀 감정을 프롬프트에 넣으면 더 풍부한 결과가 나와요!",
            },
            {
                title: "팀 브랜드 컬러 팔레트 완성",
                desc: "Gemini 추천 결과를 바탕으로 팀 브랜드 컬러 2가지와 보조 컬러 1가지를 확정해봐요.\n\n📌 결정 후 색상 이름과 HEX 코드를 적어두면 Canva에서 바로 활용할 수 있어요.",
                tip: "Canva 브랜드 키트에 컬러를 등록해두면 모든 디자인에 일관되게 적용할 수 있어요.",
            },
        ],
    },
    {
    ...
    },
    {
        id: "copywriting",
        emoji: "✍️",
        title: "카피 해부 → AI 퓨샷 공략법",
        desc: "실제 상품 카피를 분석하고, 그 감성을 AI 레퍼런스로 던져주는 퓨샷 프롬프팅 실습 (2차시 연계)",
        color: "#4361EE",
        bg: "#EEF1FD",
        difficulty: "초급",
        duration: "20분",
        ...
        steps: [
            {
                title: "실제 상품 카피 찾기",
                desc: "인스타그램·쿠팡·올리브영 등에서 평소 관심 있는 상품의 광고 문구나 상세페이지 카피 1~2줄을 메모해요.",
                tip: "'스펙(10000mAh 배터리)'보다 '혜택(하루 종일 충전 걱정 없이)'을 강조한 카피를 찾아요!"
            },
            {
                title: "카피 3가지 특징 분석하기",
                desc: "찾은 카피를 보며 체크해요: ① 어떤 감정(공감/유머/긴박감)을 건드렸나? ② 어떤 혜택을 강조했나? ③ 눈길을 끈 단어는 무엇인가?",
                tip: "예: '지금 안 사면 후회해요' → 희소성 + 손해 회피 심리. '아침이 달라졌어요' → 일상 변화 공감"
            },
            {
                title: "퓨샷(Few-shot) 프롬프트 작성",
                desc: "AI에게 내 레퍼런스 카피를 '예시'로 먼저 보여주고, 그 감성을 따라 새 카피를 만들어달라고 해요. 아래 템플릿을 복사해서 바로 써보세요!",
                tip: "레퍼런스가 없을 때보다 있을 때 AI 결과물이 훨씬 구체적이고 자연스러워져요 🚀"
            },
            {
                title: "AI가 준 3가지 버전 비교하기",
                desc: "감성형 / 유머러스형 / 정보(가성비)형 중에서 내 타겟에게 가장 잘 맞는 1가지를 골라요.",
                tip: "골라서 팀원들과 공유하고, 왜 이 카피가 더 좋은지 한 문장으로 설명해봐요"
            },
            {
                title: "내 스타일로 다듬기 + 질문으로 마무리",
                desc: "AI 글을 그대로 쓰지 말고 내 말투로 조금 바꿔요. 마지막에 '여러분은 어떻게 생각하나요?' 같은 질문을 달면 댓글이 늘어요!",
                tip: "댓글이 많으면 알고리즘이 더 많이 노출시켜줘요"
            },
        ],
        promptTemplate: `너는 10년 차 베테랑 인스타그램 퍼포먼스 마케터야.
20대 타겟을 대상으로 [상품명]을 홍보하는 광고 카피 3가지를 작성해 줘.
...
[참고 예시] 내가 찾은 레퍼런스 카피는 이거야:
"(여기에 찾은 카피를 붙여넣기)"
이 카피의 매력적인 포인트(감정 자극 방식, 단어 선택 등)를 참고해서 작성해 줘.`,
    },
    {
        id: "hashtag-research",
        emoji: "#️⃣",
    ...
    {
        id: "ai-content-project",
        emoji: "🚀",
        title: "[수업 가이드] AI 활용 홍보 콘텐츠 제작 프로젝트",
        desc: `상품이나 서비스를 직접 체험하고 특징을 파악한 후, 타겟 분석과 콘텐츠 제작을 거쳐 업로드하는 단계별 통합 프로젝트 가이드입니다.`,
        color: "#4361EE",
        bg: "#EEF1FD",
        difficulty: "초급",
        duration: "40분",
        ...
        steps: [
            {
                title: "1단계: 직접 체험하기 (오감 공유)",
                desc: `동영상 시청 대신, 아래의 링크로 접속하여 **무형의 서비스 상품(게임 서비스)**을 직접 체험해 보고 어떤 특징을 가지고 있는 상품인지 팀원들과 이야기해 보세요.

🔗 **체험 링크:** [미스터리 크래프터 (Mystery Crafter)](https://mystery-crafter.vercel.app/)

🛠️ **활동 내용:** 
* 사이트에 접속하여 게임의 첫인상과 흐름을 경험합니다.
* 서비스의 핵심 재미 요소가 무엇인지 파악합니다.`
            },
            {
                title: "2단계: 특징 분석 (차별점 정리)",
                desc: `체험한 내용을 바탕으로 가이드 질문에 답하며 상품의 USP(차별점)를 정리해 보세요.

**📌 유형의 상품 (Physical)**
* **감각적 경험:** 처음 접했을 때 느껴지는 디자인, 색상, 마감 처리
* **인체와 물성:** 무게, 그립감, 재질감(촉각 등)의 첫인상
* **기능적 문제 해결:** 어떤 일상의 물리적 불편함을 해결해 주는가?

**🌐 무형의 서비스 (Software/Service)**
* **인터페이스(UI):** 첫 화면의 직관성, 사용성, 디자인 색상 톤
* **이용 경험(UX):** 로딩 속도, 간결한 회원가입/사용 단계의 편리함
* **심리적/경제적 가치:** 시간 절약, 재미 제공, 고충 해결

> **💡 질문 생성이 막막할 땐? (프롬프트 복사사용)**
> 
> "우리는 지금 [무형/유형] 상품인 [상품명]을 분석하고 있어. 특징을 아주 세밀하게 파악해서 홍보 포인트를 잡고 싶은데, 학생 수준에서 대답해 볼 수 있는 구체적인 질문 5가지만 만들어줘. (시각적 느낌, 사용 편리성, 해결해주는 문제 등을 포함해서)"`
            ...
            {
                title: "3단계: 타켓팅 (페르소나 생성 AI)",
                desc: `분석된 특징을 AI 프롬프트에 넣어 가상 고객 프로필을 생성해보세요.

📌 아래 제시된 **페르소나 프로필 생성 프롬프트**를 복사해서 대화형 AI(Gemini 등)에 입력해 보세요!`,
                tip: `AI가 생성한 가상 페르소나의 SNS 말투를 복사해 두면 나중에 '셀스타그램' 캡션을 쓸 때 유용해요.`
            },
            {
                title: "4단계: 콘텐츠 제작 (4컷 만화 및 이미지)",
                desc: `페르소나의 스토리를 담은 4컷 만화 형태나 광고용 비주얼 이미지를 제작해 보세요.

🛠️ **준비물/도구:** 이미지 생성 AI 및 생성 프롬프트`
            },
            {
                title: "5단계: 업로드 및 공유 (성과 트래킹)",
                desc: `가상의 SNS **'sellstagram'**에 제작한 콘텐츠를 게시하고 팀 피드백 및 인게이지먼트 성과를 확인하세요!

🛠️ **준비물/도구:** sellstagram 실습 플랫폼`
            }
        ],
        promptTemplate: `# 역할: 너는 전문 마케팅 전략가야.
...
4. 구매 결정적 이유: (페르소나의 어떤 부분이 이 상품과 연결되는지)
